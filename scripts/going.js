      ...
      <div class="cart-item-details-grid">
        ...
        <div class="cart-item-details">
          ...
          <div class="product-quantity">
            ...
            <span class="quantity-status js-quantity-status-${matchingProduct.id}"></span>
...
document.querySelectorAll(".js-update-quantity-link").forEach((link) => {
  link.addEventListener("click", () => {
    ...
    // Set the input value to current quantity
...
document.querySelectorAll(".js-save-quantity-link").forEach((link) => {
  link.addEventListener("click", () => {
    ...
    if (
      ...
      statusElement.textContent = "Please enter a quantity between 1 and 1000.";
    ...
    statusElement.textContent = "Quantity updated successfully";
...
document.querySelectorAll(".js-delivery-option").forEach((element) => {
  element.addEventListener("click", () => {
    ...
    const newDeliveryDate = dayjs()
      .add(selectedOption.deliveryDays, "day")
      .format("dddd, MMMM D");
